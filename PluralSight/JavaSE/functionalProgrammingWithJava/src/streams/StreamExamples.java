...
public class StreamExamples {
    public static void main(String[] args) throws IOException {
        ...
        Stream<String> rows1 = Files.lines(Paths.get("data10.txt"));
        ...
        rows1.close();
//        11.Stream row from CSV file, parse data from rows
        Stream<String> rows2 = Files.lines(Paths.get("data10.txt"));
        rows2
                .map(x->x.split(","))
                .filter(x->x.length==3)
...
//        12.Stream row from CSV file, store fields in HashMap
        Stream<String> rows3 = Files.lines(Paths.get("data10.txt"));
        Map<String,Integer> map = new HashMap<>();
        map = rows3
                .map(x->x.split(","))
                .filter(x->x.length==3 && Integer.parseInt(x[1])>15)
